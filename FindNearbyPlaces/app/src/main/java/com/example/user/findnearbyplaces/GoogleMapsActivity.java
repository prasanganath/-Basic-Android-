package com.example.user.findnearbyplaces;
...

{
    ...
    {
        String cargils = "cargils", school = "school", restaurant = "restaurant";
        ...
        switch (v.getId())
        {
            case R.id.search_address:
                ...
                break;
            case R.id.cargils_nearby:
                mMap.clear();
                String url = getUrl(latitide, longitude, cargils);
                transferData[0] = mMap;
                transferData[1] = url;

                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Searching for Nearby Cargils..", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Showing Nearby Cargils..", Toast.LENGTH_SHORT).show();
    ...
    private  String getUrl(double latitide,double longitude,String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyDQJiMdYaupuT0gTrJwdIJ8_izgWfaGnkw");
